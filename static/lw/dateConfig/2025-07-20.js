...
const ywk = {
    layer1: {
        '4-1': { color: '#16beae', alpha: 0.3, text: 'Drop' },
        '4-2': { color: '#16beae', alpha: 0.8, text: '' },
        '4-3': { color: '#16beae', alpha: 0.8, text: 'Capture' },
        '5-1': { color: '#16beae', alpha: 0.3, text: 'Drop' },
    ...
    layer2: {
        '3-0': { color: '#16beae', alpha: 0.3, text: 'Drop' },
        '3-1': { color: '#16beae', alpha: 0.8, text: '' },
        '4-0': { color: '#16beae', alpha: 0.3, text: 'Drop' },
        '4-1': { color: '#16beae', alpha: 0.8, text: 'Capture' },
        '5-0': { color: '#16beae', alpha: 0.8, text: '' },
        '5-1': { color: '#16beae', alpha: 0.8, text: 'Capture' },
...
const R1s = {
    ...
    layer2: {
        '0-4': { color: '#cdbc35', alpha: 0.8, text: 'R1s' },
        '0-5': { color: '#cdbc35', alpha: 0.8, text: 'R1s' },
        '0-6': { color: '#cdbc35', alpha: 0.8, text: 'R1s' },
        '0-7': { color: '#cdbc35', alpha: 0.8, text: 'R1s' },
...
const EnM = {
    layer1: {
        ...
        '0-11': { color: '#d67b1c', alpha: 0.8, text: 'EnM' },
        '0-12': { color: '#d67b1c', alpha: 0.8, text: 'EnM' },
...
const ssss = {
    layer1: {
        '12-2': { color: '#c74138ff', alpha: 0.8, text: 'ssss' },
    },
    layer2: {
        '11-1': { color: '#c74138ff', alpha: 0.8, text: 'ssss' },
        '11-2': { color: '#c74138ff', alpha: 0.8, text: 'ssss' },
    },
};

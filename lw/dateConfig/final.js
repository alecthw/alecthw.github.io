...
const ywk = {
    layer1: {
        '4-5': { color: '#16beae', alpha: 1, text: 'ywk' },
        ...
        '8-4': { color: '#16beae', alpha: 1, text: 'ywk' },
    },
    layer2: {
...
const R1s = {
    layer1: {
        '4-4': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-5': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-6': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-7': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-8': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-9': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '4-6': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '5-6': { color: '#cdbc35', alpha: 1, text: 'R1s' },
    },
    layer2: {
        '4-3': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-4': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '2-5': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '2-6': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '2-7': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '2-8': { color: '#cdbc35', alpha: 1, text: 'R1s' },
        '3-5': { color: '#cdbc35', alpha: 1, text: 'R1s' },
...
const Omz = {
    layer1: {
        '7-6': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '8-5': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '8-6': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-3': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-4': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-5': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-6': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-7': { color: '#62bd32', alpha: 1, text: 'Omz' },
    },
    layer2: {
        '7-6': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '8-4': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '8-5': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '8-6': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-4': { color: '#62bd32', alpha: 1, text: 'Omz' },
        '9-5': { color: '#62bd32', alpha: 1, text: 'Omz' },
...
const TUPA = {
    layer1: {
        ...
        '6-7': { color: '#df697f', alpha: 1, text: 'TUPA' },
        '7-7': { color: '#df697f', alpha: 1, text: 'TUPA' },
        '7-8': { color: '#df697f', alpha: 1, text: 'TUPA' },
        '8-8': { color: '#df697f', alpha: 1, text: 'TUPA' },
    },
    layer2: {
        '3-6': { color: '#df697f', alpha: 1, text: 'TUPA' },
